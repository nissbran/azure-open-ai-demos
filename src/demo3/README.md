# Demo3 - Microsoft.Extensions.AI + RAG

Azure OpenAI with RAG integration using the Microsoft.Extensions.AI libraries for .NET. Function calling with Azure AI Search.
