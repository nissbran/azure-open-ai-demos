...
{
    private readonly ChatWithAgentsService _chatService;
    private readonly ActivitySource _activitySource;
    private const string BotName = "Truck supply chain assistant";

    public ConsoleChat(ChatWithAgentsService chatService, ActivitySource activitySource)
    {
        ...
        try
        {
            while (cancellationToken.IsCancellationRequested == false)
            {
                ...
                switch (message)
                {
                    ...
                    case "/print":
                        await _chatService.PrintTheChatAsync();
                        break;
                    default:
    ...
    private void WriteWelcomeMessage()
    {
        ...
        AnsiConsole.MarkupLine("[bold green]The truck supply chain assistant is here to help you![/]");
